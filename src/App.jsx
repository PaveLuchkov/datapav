  ...
  return (
    <DragProvider>
      <div className="w-screen h-screen bg-slate-900 flex flex-col" onKeyDown={handleKeyDown} tabIndex={0}>
        ...
        {/* GitHub link */}
        <a
          href="https://github.com/PaveLuchkov/datapav"
          target="_blank"
          rel="noreferrer"
          title="GitHub"
          className="fixed top-3 right-12 z-20 w-7 h-7 rounded-full flex items-center justify-center transition-all duration-150 hover:scale-110"
